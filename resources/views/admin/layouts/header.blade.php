                        ...
                        <div class="top-menu d-flex align-items-center">
                            ...
                            <a href=""></a>
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                                 ...
                                 <a class="dropdown-item" href= "{{ route('doctor.create') }}"><i class="ik ik-power dropdown-icon"></i>Logout</a>
                                 <a class="dropdown-item" href=""
                                  ...
                                  <i class="ik ik-power dropdown-icon"></i>      {{ __('Logout') }}
                                    ...
                                    <form id="logout-form" action="{{ route('doctor.create') }}" method="POST" style="display: none;">
                                        @csrf
                                    </form>
